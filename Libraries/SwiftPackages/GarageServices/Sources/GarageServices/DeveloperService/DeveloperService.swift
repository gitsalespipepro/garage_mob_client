...
public struct DeveloperServiceURLs {
...
public protocol DeveloperService {
    func fetchDevelopers() async throws -> [GetDevelopersResponseModel]
}

public final class DeveloperServiceImpl {
...
extension DeveloperServiceImpl: DeveloperService {
    public func fetchDevelopers() async throws -> [GetDevelopersResponseModel] {
