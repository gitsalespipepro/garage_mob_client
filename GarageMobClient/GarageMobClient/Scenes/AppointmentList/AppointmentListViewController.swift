...
final class AppointmentListViewController: UIViewController {
    ...
    private var viewModel: IAppointmentListViewModel?
    ...
    func setDependencies(viewModel: IAppointmentListViewModel?) {
...
private extension AppointmentListViewController {
    ...
    func setupSubscriptions() {
        ...
        let input = AppointmentList.Models.ViewModelInput(
    ...
    func handleState(_ state: AppointmentList.Models.ViewState) {
        switch state {
        case .idle:
            break
        }
    ...
    func handleAction(_ action: AppointmentList.Models.ViewAction) {
        switch action {
        }
    }
    
    func handleRoute(_ route: AppointmentList.Models.ViewRoute) {
        switch route {
        }
    }
}
