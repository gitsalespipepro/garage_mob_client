...
final class ProfileViewController: UIViewController {
    ...
    func setDependencies(viewModel: IProfileViewModel?) {
...
private extension ProfileViewController {
    ...
    func setupSubscriptions() {
        ...
        let input = Profile.Models.ViewModelInput(
    ...
    func handleState(_ state: Profile.Models.ViewState) {
        switch state {
        case .idle:
            break
        }
    ...
    func handleAction(_ action: Profile.Models.ViewAction) {
        switch action {
        }
    }
    
    func handleRoute(_ route: Profile.Models.ViewRoute) {
        switch route {
        }
    }
}
